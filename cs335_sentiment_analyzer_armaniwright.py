# -*- coding: utf-8 -*-
"""cs335_sentiment_analyzer_armaniwright.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1tWcnPLH1fWmLnldDWfEPuvBkATS563MP
"""
...
positive_words = {
    'happy', 'ecstatic', 'gracious', 'serene', 'charming', 'uplifted',
    'sparkling', 'fabulous', 'playful', 'enthusiastic', 'honest',
    'lovely', 'amazing', 'inspired', 'radiant', 'peaceful'
}
negative_words = {
    'sad', 'melancholy', 'agitated', 'panicked', 'grumpy', 'pessimistic',
    'insecure', 'regretful', 'disappointed', 'dismayed', 'desolate',
    'lonely', 'resentful', 'worried', 'apathetic', 'irritable'
}
...
# 3. Compute simple sentiment score (hint: positive - negative count)
    ...
    print(f"Sentiment Score: {score} => Sentiment: {sentiment}")
...
"""
The lab has shown me that a lexicon based approach is simple,
interpretable, and easy to customize; because of this,
it is a great starting point for basic sentiment analysis.
However, because of this, it also lacks contextual understanding,
causing it to struggle with sarcasm, negations, or words that shift meaning based on phrasing or tone.
"""